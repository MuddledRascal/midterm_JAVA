...
public class Numbers {
	...
	public static void main(String[] args) throws Exception {
		...
		List<String> numbers4 = connectToSqlDB.readDataBase("shell_sort", "SortingNumbers");
		printValue(numbers4);
		...
		List<String> numbers5 = connectToSqlDB.readDataBase("bubble_sort", "SortingNumbers");
		printValue(numbers5);
		...
		/*Come to conclusion about which Sorting Algo is better in given data set.
		 Answer: given this data set the worst performing algorithm was Bubble Sort.
			The best performing algorithm was heap sort.
